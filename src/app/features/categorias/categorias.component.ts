    ...
    <div class="h-full flex flex-col bg-transparent max-w-7xl mx-auto w-full gap-4">
      <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        ...
        <div class="flex items-center gap-3">
          <button (click)="vistaTarjetas.set(!vistaTarjetas())" class="bg-white border border-slate-300 text-slate-700 hover:bg-slate-50 font-medium py-2 px-3 rounded-md shadow-sm transition-colors flex items-center justify-center" title="Cambiar Vista">
            @if (vistaTarjetas()) {
